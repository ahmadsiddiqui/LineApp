 ...
 * @author Shai Almog
 */
public class LineAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "LineApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new LineAppStub());
    }
